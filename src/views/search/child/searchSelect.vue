  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="trade in trademarkList" :key="trade.tmId" @click="tradeClick(trade)">{{trade.tmName}}</li>
        </ul>
      </div>
      <div class="ext">
    ...
    <div class="type-wrap" v-for="attr in attrsList" :key="attr.attrId">
      ...
      <div class="fl value">
        <ul class="type-list">
          <li v-for="(attrValue,index) in attr.attrValueList" :key="index" @click="attrClick(attr,attrValue)">
            <a>{{attrValue}}</a>
          </li>
        </ul>
      </div>
